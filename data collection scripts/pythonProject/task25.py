...
for index, row in urls_df.iterrows():
    ...
    if response.status_code == 200:
        ...
        for scorecard_table in scorecard_tables:
            # Find the preceding country name in the span with class 'ds-text-title-xs ds-font-bold ds-capitalize'
            country_name_tag = scorecard_table.find_previous('span', class_='ds-text-title-xs ds-font-bold ds-capitalize')
            ...
            for link in player_links:
                ...
                with open(output_csv, 'a', newline='') as file:
                    ...
                    writer.writerow([player_name, player_id, url, team1, team2, winner, ground, margin, matchDate, matchDate, scorecard, country_name])
